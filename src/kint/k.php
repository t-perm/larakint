...
class Kint
{
    ...
    private static function _getPassedNames($trace)
    {
        ...
        return [$parameters, $modifiers, $callee, $previousCaller, $miniTrace];
    }
    ...
    private static function _getCallerInfo($trace)
    {
        ...
        while ($step = array_pop($trace)) {
            ...
            if (self::_stepIsInternal($step)) {
                ...
                array_unshift($miniTrace, [$step['file'], $step['line']]);
            }

            $prevStep = $step;
        }

        return [$previousCaller, $miniTrace, $step];
    }
    ...
    {
        $trace          = [];
        $tracePrototype = ['file', 'line', 'args', 'class'];
